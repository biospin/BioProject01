...
## 작업 절차
0. `full.md`의 현재 내용 전체를 읽는다. Background, Overview, Figure, Results에서 사용된 주장, 수치, 비교를 파악한 뒤 Discussion을 시작한다.
1. 저자가 Discussion이나 Limitation에서 명시한 한계를 먼저 정리한다.
2. 앞서 읽은 Background, Overview, Figure, Results에서 드러난 약한 연결을 다시 본다.
