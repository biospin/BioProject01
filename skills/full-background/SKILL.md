...
description: Analyze the Background section of a full scientific paper review. Use when Codex needs to explain why a paper became necessary, what prior work achieved and failed to solve, what research gap led to the proposed work, and what basic concepts are needed to understand the paper.
---

# Full Background

## 목표
논문의 Background를 단순 선행연구 나열이 아니라 “왜 이 논문이 나올 수밖에 없었는가”에 대한 배경 스토리로 정리한다. 기존 방법 A, B, C가 각각 무엇을 했고 무엇을 해결하지 못했는지 연결해서, 이 논문이 해결하려는 문제로 자연스럽게 이어지게 만든다.
