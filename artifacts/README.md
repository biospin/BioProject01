...
- `2026-06-08-bioproject01-web-dashboard-presentation.md` — presentation-ready Markdown deck for explaining the dashboard harness to teammates. Includes the 2026-06-09 Claude port appendix slides.
