...
In HSPC the per-gene lag did not concord. Under the magnitude convention the strongest of the three pairwise Spearman correlations reaches +0.163 (Figure 1), with a bootstrap interval excluding 0 and most pairs at |ρ|≤0.08; the signed and unified conventions are no better, and no restriction of the gene set recovers a usable rule (Appendix B). Direction was little better. The chromatin-leads fraction sat near 50/50 across the three sign-variable methods (Appendix B), which does not support a genome-wide "chromatin primes transcription" ordering, and sign agreement between MoFlow and MultiVeloVAE was 54.6% (n=560; binomial p=0.03), a detectable but practically negligible excess.
...
[6] El Kazwini N, Gao M, Kouadri Boudjelthia I, Cai F, Huang Y, Sanguinetti G. CRAK-Velo: chromatin accessibility kinetics integration improves RNA velocity estimation. *Genome Biology* 27(1), 209 (2026). doi:10.1186/s13059-026-04086-y.
...
[41] Zhang H, Bochkina N, Wade S. Quantifying uncertainty in RNA velocity. *Biometrics* 82(1), ujag018 (2026). doi:10.1093/biomtc/ujag018.
...
[55] Gu J, Laszik N, Miles CE, Allard J, Downing TL, Read EL. Scalable inference and identifiability of kinetic parameters for transcriptional bursting from single cell data. *Bioinformatics* 41(11), btaf581 (2025). doi:10.1093/bioinformatics/btaf581.
