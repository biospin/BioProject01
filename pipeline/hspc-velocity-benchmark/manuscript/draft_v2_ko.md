...
**Fig. 1.** HSPC에서 유전자별 시간차(lag)와 전사 속도 α의 cross-method 일치도. 시간차 크기 쌍별 산점/순위 행렬(대부분의 쌍 |ρ|≤0.08, 가장 강한 쌍 +0.163)과 부호 일치(48%)를 α 재현성 산점(ρ=0.88)과 대비. *배치: Results 서두.*
