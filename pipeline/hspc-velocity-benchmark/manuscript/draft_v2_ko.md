...
**Additional file 12: Table S10.** 세포 수준 velocity 행렬 감사 — 방법 쌍별 세포별·유전자별 코사인 유사도와 세포 셔플 귀무, 평균 중심화 값, (세포,유전자) 부호 일치, ATAC-shuffle 대조, 재적합 재현성 천장, 그리고 봉인된 사전등록과 채점 결과. (.csv, .pdf)
