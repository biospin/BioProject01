...
| 2 | Jaemyun Lyu | `jaemyunlyu@gmail.com`, `siegfried@yonsei.ac.kr` | 본인 지정, BIOP01-79 #11908 · BIOP01-89 #12204 |
...
**류재면 님은 공식 주소가 두 개다.** 2026-09-11 BIOP01-89 #12204에서 본인이
`siegfried@yonsei.ac.kr`(연세대)와 `jaemyunlyu@gmail.com` 둘 다 공식이라고 알려 주었다.
제출 폼에 자리표시로 들어간 주소는 `jaemyunlyu@gmail.com`이므로 프로필에 두 주소가 모두 있어야
이 논문이 계정에 붙는다.
...
이해충돌 정보도 그분들 프로필에서 읽힌다.

**✅ 2026-09-11 저녁: 공저자 5인 전원 OpenReview 프로필 보유.** 류재면 님이 마지막으로 생성했다
(`~Jaemyun_Lyu1`, 이름 `Jaemyun Lyu` / `Jae-Myun Lyu`, 소속 Genolution Inc.).
심사자 배정(9월 14일) 전에 끝나 이해충돌 정보가 배정에 반영된다.

⚠️ **류재면 님 프로필의 두 이메일이 모두 Confirmed이나, gmail 쪽이 어느 주소인지는 화면상 마스킹돼
구분되지 않는다**(`jaemyunlyu@gmail.com` 대 커밋용 `siegfried.lyu@gmail.com`). 제출 폼 자리표시는
전자이므로 그 주소라야 논문이 프로필에 붙는다. 확인은 forum `eGy4QuhHdP`의 저자 줄에서 이름이
프로필 링크로 보이는지로 한다.
