...
- `manuscript/draft_v2.md` sha256[:16] = `7efa58f58ea30fc3`
- `manuscript/draft_v2_ko.md` sha256[:16] = `76961441a6e438ff`
- git HEAD = `289970c` | 위험 Tier = **3 (투고·공개)** | correction cap = 2
