...
- `manuscript/draft_v2.md` sha256[:16] = `f2df5a6aa86cc22f`
- `manuscript/draft_v2_ko.md` sha256[:16] = `39fc5e82468c2432`
- git HEAD = `6721995` | 위험 Tier = **3 (투고·공개)** | correction cap = 2
